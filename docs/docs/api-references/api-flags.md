---
sidebar_position: 6
title: API Reference Regex Execution Flags
description: Detailed guide on regex flags in TS-Rex, including global, ignoreCase, multiline, dotAll, withIndices, and ES2024 unicodeSets.
---
