...
declare module '../core/builder' {
  interface RegexBuilder<TCaptures, TFlags> {
     ...
     * Maps to `(?:...)`.
     */
    group<InnerCaptures extends Record<string, any>, InnerFlags extends Record<string, any>>(
     ...
     * Maps to `(?<Name>...)`.
     */
    capture<Name extends string, InnerCaptures extends Record<string, any>, InnerFlags extends Record<string, any>>(
      name: Name,
      builder: RegexBuilder<InnerCaptures, InnerFlags>
...
RegexBuilder.prototype.group = function <
  ...
  InnerFlags extends Record<string, any>
>(builder: RegexBuilder<InnerCaptures, InnerFlags>) {
